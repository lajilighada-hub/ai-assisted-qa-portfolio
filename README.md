...
|---------|-----------------|
| **Testmanagement** | Jira, Xray, TestRail, Zephyr |
| **KI-Tools** | ChatGPT, Claude, GitHub Copilot |
| **Automation** | Selenium, Playwright, Cypress, pytest |
| **API-Testing** | Postman, REST Assured, curl |
| **CI/CD** | GitHub Actions, Jenkins |
| **Versionierung** | Git, GitHub |
| **Sprachen** | Python, JavaScript, Java, SQL |
| **Methoden** | ISTQB-konform, agil/scrum, risk-based testing |
